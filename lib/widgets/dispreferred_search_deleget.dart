    ...
    if (searchResults.isNotEmpty && query.isNotEmpty) {
      ...
      return StreamBuilder(
          stream: Stream.fromFuture(
            _backendController.ingredientDispreferredSearch(query),
          ),
          builder:
            ...
            children: [
              AddIngredientListTile(
                ...
                onClick: () async {
                  ...
                  final String response = await widget.controller
                      .addDisPreferredIngredient(
                          widget.searchResults[index]['ingredient'].id);

                  Navigator.pushNamedAndRemoveUntil(
                      context, 'disPrefIng/', ModalRoute.withName('profile/'));
